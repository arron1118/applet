define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'user.news_collect/index',
        add_url: 'user.news_collect/add',
        edit_url: 'user.news_collect/edit',
        delete_url: 'user.news_collect/delete',
        export_url: 'user.news_collect/export',
        modify_url: 'user.news_collect/modify',
    };
