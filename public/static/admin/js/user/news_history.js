define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'user.news_history/index',
        add_url: 'user.news_history/add',
        edit_url: 'user.news_history/edit',
        delete_url: 'user.news_history/delete',
        export_url: 'user.news_history/export',
        modify_url: 'user.news_history/modify',
    };
